			...
			(<div className="columns">
				...
				<div className="column is-half">
					<div style={{ height: '500' }}>
						...
						<div className="content" style={{ height: '25%' }}>
				...
				<div className="column is-half">
					<div style={{ height: '500px' }}>
						<div className="media" style={{ boxSizing: 'border-box', border: '1px solid grey' }}>
							<div className="media-left" style={{ height: '50%' }}>
								<figure className="image" style={{ height: '50%', maxWidth: '220px' }}>
						...
						<div className="media" style={{ boxSizing: 'border-box' }}>
							<div className="media-left" style={{ height: '50%' }}>
								<figure className="image" style={{ height: '50%', maxWidth: '240px' }}>
